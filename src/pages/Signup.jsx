      ...
      >
        ...
        <div className="hero-content relative z-10 container">
          ...
          >
            ...
            <div className=" bg-red-100  p-10 text-red-400  w-full md:col-span-3 lg:col-span-2 z-50">
              <div className="mb-10">
              ...
              <form onSubmit={handelesubmit} className="mt-5 space-y-5">
                ...
                <div className="btn p-0 overflow-hidden flex justify-between w-full text-red-400  capitalize relative ">
                  <div className="ml-2">
                ...
                <button
                  type="submit"
                  className="btn text-white w-full hover:bg-red-400  bg-red-400  border-none "
              ...
              <button
                ...
                className="border border-red-400  flex items-center justify-center gap-3  p-3 mt-6 w-full rounded-lg font-bold"
              >
                <img
                  className="h-6"
