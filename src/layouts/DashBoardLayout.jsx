      ...
      <div className="w-11/12 mx-auto">
        <div className="h-[700px] md:h-[800px] lg:h-[900px] rounded-lg overflow-hidden bg-base-50 ">
          ...
          <div className="mainpart flex h-[85%] md:h-[90%]">
            <div
              className={`sidebar text-center lg:text-start overflow-y-auto  w-[80px] lg:w-2/6 xl:w-1/6 ${
            ...
            <div
              ref={contineref}
              className={`custom-scrollbar contentpart overflow-y-auto w-full lg:w-4/6 xl:w-5/6 h-full bg-opacity-50  ${
