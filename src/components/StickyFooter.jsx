  ...
  return (
    <div className="StickyFooter">
      <div className="container  mx-auto">
        <div className=" p-10 -mt-48 text-center rounded-lg bg-red-100 shadow-lg relative">
          <div className="relative z-10">
            <div className="text-center  space-y-5">
              <h1 className="text-4xl font-bold text-red-400  font-Montserrat">
                Join our newsletter
              </h1>
          ...
          <div className="shape top-0 left-0 clipshape3 absolute h-full w-full bg-red-200"></div>
        </div>
      </div>
    </div>
  );
