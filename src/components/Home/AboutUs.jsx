  ...
  return (
    <div className="container mx-auto grid items-center grid-cols-1 mt-40 my-20 lg:grid-cols-2  lg:gap-20">
      <div className="ourFacinate relative">
        ...
        >
          <h1 className="text-3xl md:text-6xl  text-red-400  font-bold font-Montserrat">
            <CountUp
              start={0}
              suffix="+"
              scrollSpyOnce={true}
      ...
      <div data-aos="fade-left" className="aboutus  lg:mt-0  mt-20">
        <div className="introduct space-y-5">
          <span className="text-2xl text-red-400  ">Introduction</span>
          <h1 className="text-4xl  text-red-400   font-Montserrat font-bold">
            TaskTrove Your Trusted Partner in Home Services
          </h1>
          <p className="text-lg leading-8">
            TaskTrove is a leading online platform that connects homeowners with
            ...
            services, or any other home maintenance task, TaskTrove simplifies
            the process of finding reliable professionals.
          </p>
          <div>
            <button className="btn mt-5 lg:btn-lg hover:scale-105 hover:bg-red-400   bg-red-400  text-white">
              Explore more
            </button>
          </div>
        </div>
