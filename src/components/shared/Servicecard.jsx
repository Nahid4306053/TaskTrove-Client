...
export default function Servicecard({ service }) {
  return (
    <div className="card service_card overflow-hidden  bg-red-100 card-compact   shadow-xl">
      <div className="p-2">
      ...
      <div className="card-body z-[2] relative mt-3 text-center">
        <div>
          <div className="main_info absolute -top-12 w-10/12 left-[8%]  text-xl font-bold text-red-400    my-2">
            ...
            <div className="details h-18 z-10 shadow-lg  rounded-lg   p-5 bg-white relative  xl:text-lg text-sm flex justify-between w-full">
              ...
              <div className="rating">
                ...
                />
                <div>
                  <div className="px-2 ml-2  bg-red-400  text-white xl:mt-1 rounded-sm text-sm font-bold">
                    {service.rating}
                  </div>
                </div>
              </div>
          ...
          <div className="main_details space-y-2 relative z-10">
            ...
            <div>
              <Link to={`/service-details/${service._id}`}>
                <button className="btn mt-2  hover:scale-105 hover:bg-red-400   bg-red-400  text-white">
        ...
        <div className="clipshape z-[1] h-full w-full absolute top-0 bg-red-200 left-0"></div>
      </div>
    </div>
  );
}
