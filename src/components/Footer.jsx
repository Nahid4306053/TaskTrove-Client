...
export default function Footer() {
  ...
  return (
    <>
      <footer className={`  ${Darkmood ? "bg-base-300" : " bg-red-50"} `}>
        <div className="grid  mt-10  container gap-8 mx-auto lg:grid-cols-4 md:grid-cols-2 grid-cols-1">
          <div className="about_info mt-10">
            ...
            <div className="info mt-5 flex gap-4 items-center">
              <h2 className="text-4xl   text-red-400  w-10">
                <strong>
          ...
          <div className="links mt-10">
            <h1 className="shops mt-4 text-2xl font-bold text-red-400  ">
              Packages
            </h1>
          ...
          <div className="links mt-10">
            ...
            <div className="grid mt-10 lg:max-w-[280px] grid-cols-3 gap-5">
              <img
                src="https://i.ibb.co/K7Y1QnY/climbing-nevado-ishinca1.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
              <img
                src="https://i.ibb.co/mvvCd3P/Nikkaluokta-Vakkotavare-Kungsleden-Trail.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
              <img
                src="https://i.ibb.co/yRmGBtx/smokies.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
              <img
                src="https://i.ibb.co/QMH7X0z/3day-tortuguero-2-lg.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
              <img
                src="https://i.ibb.co/xSwmNjf/15.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
              <img
                src="https://i.ibb.co/M59QYBL/145.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
              <img
                src="https://i.ibb.co/fdwSDz3/sea-to-summit-allie-pepper-blog-6.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
              <img
                src="https://i.ibb.co/WkDzJS4/sporty-zimowe-dla-dzieci-snowboard-122105-1-X.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
              <img
                src="https://i.ibb.co/gWp4SW9/annapurna-base-camp-13-640-480.jpg"
                className="h-full w-full object-cover"
                alt=""
              />
            </div>
        ...
        <div className={`coppwright  "bg-[#09253D]"  `}>
